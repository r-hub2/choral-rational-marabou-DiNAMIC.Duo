...
#'
#' @format A numeric matrix of quantitative DNA copy number values with 3480 rows and 60 columns.
...
#'   contained gene-level segmented DNA copy number values for 24776 genes and 501 samples
...
#'   the number of genes and samples in the lung squamous cell carcinoma data is different
#'   than the number of genes and samples in the lung adenocarcinoma data.
"luscSubset"